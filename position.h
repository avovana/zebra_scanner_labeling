...
public:
    ...
    virtual void set_reason_of_canceletion(const std::string cancel_reason) = 0;
};
...
public:
    ...
    void set_reason_of_canceletion(const std::string cancel_reason) {
...
public:
    ...
    void write_scan(const std::string &file_name, const std::string &bar_code) override {
        ...
        myfile << bar_code << ","
               << position.reason_of_cancellation
               << ",,,,";
//               << position.price << ","
//               << position.document_type << ","
//               << position.document_number << ","
...
//               << position.document_name;
    ...
    void set_reason_of_canceletion(const std::string cancel_reason) {
        position.reason_of_cancellation = cancel_reason;
    }
